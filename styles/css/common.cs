...
.cn .page1 .head .title1 span, .cn .page1 .title span {
  font-style: normal; }
...
.page1 {
  ...
  .page1 .keypad {
    ...
    .page1 .keypad .pic {
      ...
      .page1 .keypad .pic span {
        font-size: 0.24rem;
        color: #fff; }
        .page1 .keypad .pic span.icon-exit {
          animation: fadeIn 2s;
  ...
  .page1 .mul-title i {
    font-size: 0.48rem; }
    .page1 .mul-title i:before {
      content: ''; }
    .page1 .mul-title i:after {
      top: 1.4rem; }
  .page1 .mul-pop {
    z-index: 0; }
  .page1 .icon-bo {
...
@keyframes linec {
  0%,100% {
    clip: rect(0, 5.28rem, 0.1rem, 0); }
  25% {
    clip: rect(0, 0.1rem, 3rem, 0); }
  50% {
    clip: rect(2.9rem, 5.28rem, 3rem, 0); }
  75% {
    clip: rect(0, 5.28rem, 3rem, 5.16rem); } }
@keyframes lined {
  0%,100% {
    clip: rect(2.9rem, 5.28rem, 3rem, 0); }
  25% {
...
/*# sourceMappingURL=common.cs.map */
